        ...
        return (
            <Container className="video-container">
                <Video
                    ...
                    type="infer"
                />
                <ActivityBar mode={videoIndex.index<2} questionMode={questionMode} type="infer" word={words[wordIndex.index]} incOffset={this.incOffset}/>
            </Container>
        )
    }
}

export default connect(mapStateToProps)(Infer);